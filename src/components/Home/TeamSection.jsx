...
const TeamSection = () => {
  ...
  const scroll = (dir) => {
    if (trackRef.current) {
      trackRef.current.scrollLeft += dir * 220;
    }
  };
    ...
    <div className="sec team-section">
      ...
      <div className="team-wrapper">
        <div className="team-scroll-btn" onClick={() => scroll(-1)}>
          <svg viewBox="0 0 24 24" fill="none"><path d="M15 18l-6-6 6-6" stroke="white" strokeWidth="2" strokeLinecap="round" /></svg>
        </div>
        ...
        <div className="team-scroll-btn" onClick={() => scroll(1)}>
          <svg viewBox="0 0 24 24" fill="none"><path d="M9 18l6-6-6-6" stroke="white" strokeWidth="2" strokeLinecap="round" /></svg>
        </div>
      </div>
    </div>
  );
