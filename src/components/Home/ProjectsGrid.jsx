...
const ProjectsGrid = ({ showPage, openYT }) => {
  const projects = [
  ...
  return (
    <div className="sec" style={{ background: 'var(--gray-50)' }}>
      ...
      <div className="section-title">
        Turning Visions Into<br /><span className="muted">Digital Reality</span>
      </div>
      ...
      <div className="view-all-wrap">
        <button className="btn-outline" onClick={() => alert('✨ More amazing projects coming soon!')}>
          View All Projects
        </button>
      </div>
    </div>
